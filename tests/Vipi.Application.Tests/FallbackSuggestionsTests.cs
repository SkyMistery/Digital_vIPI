...
public class FallbackSuggestionsTests
{
    ...
    {
        new(Ws2, BaseFeet: null, TopFeet: 32500),
        new(Es2, BaseFeet: null, TopFeet: 32500),
        new(Ws5, BaseFeet: 32500, TopFeet: null),
        new(Es5, BaseFeet: 32500, TopFeet: null),
    };
    ...
    /// <summary>Il caso della carta: per WS5, B propone ES5 — l'altro settore dello stesso STRATO.</summary>
    [Fact]
    public void Per_WS5_propone_ES5_con_la_sua_fascia()
    {
        var p = FallbackSuggestions.For(Ws5, Milano, Antenati(Ws2));
    ...
    /// <summary>
    /// ⚠️ Il punto della regola: WS2 è il PADRE di WS5 e gli sta esattamente sotto, ma non condivide un
    ...
    {
        var p = FallbackSuggestions.For(Ws5, Milano, Antenati());
    ...
    public void Le_proposte_escono_dalla_piu_sovrapposta()
    {
        ...
        {
            new(Es5, 32500, null),
            new("MOLTO", 32500, null),      // tutta la banda
            new("POCO", 32500, 34000),      // 1500 piedi soli
        };
    ...
    {
        var bande = new SectorBand[] { new("A", null, 32500), new("B", 32500, null) };
