...
public class AdminNavTests : TestContext
{
    ...
    public void Un_admin_vede_tutte_le_pagine()
    {
        ...
        // 16 dal 29 agosto 2026: il catalogo degli spazi aerei dell'AIP.
    ...
    public void Un_editor_vede_undici_voci()
    {
        ...
        // 11 dal 29 agosto 2026: il catalogo degli spazi aerei, che e' contenuto documentale come le
        // radioassistenze: chi cura una vIPI aggancia il CTR vero al suo avvicinamento.
