...
public class AtcTrafficRecorderTests : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _recorder = new AtcTrafficRecorder(new EfSectorVolumeCatalog(_db, new EfSectorShapeResolver(_db, new EfSectorAirspaceBindings(_db, LivelloFisso.Editor), new EfSectorShapeParts(_db))));
    }
