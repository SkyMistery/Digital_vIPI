...
**🟡 T-059 (L13, sul ramo `l13-net10`, NON in main: host net10 con EF Core 8 + Pomelo 8.0.3 invariati — ADR-0007 §D4-quater. Pomelo non ha EF 10 e EF 8/EF 9 escono dal supporto lo stesso giorno, quindi la «correzione» scritta sotto — Pomelo 9+ — non comprava niente. Provato: suite verde, pacchetto self-contained net10 che parte con `dotnet Vipi.Host.dll` sul solo runtime 8, runtime 10 su glibc 2.31. Resta: CI del ramo con `mariadb-schema` su net10, poi decisione su quando fonderlo rispetto a 1.26.1, e un carico FTP completo) — La produzione gira su .NET 8, che esce dal supporto il 10 novembre 2026.**
...
| **L13** 🟡 | **Piattaforma** | T-059 | Lavoro di settimane (Pomelo 9+, riverifica del set MySQL, CI net10): va aperto ora, la scadenza è il 10 novembre. Fatto il 13-set in un giorno sul ramo `l13-net10` senza Pomelo 9: EF 8 resta, cambia il runtime (ADR-0007 §D4-quater) |
