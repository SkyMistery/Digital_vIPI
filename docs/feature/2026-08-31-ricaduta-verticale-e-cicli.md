...
**E lo stesso gesto sulla pagina ACC** (`admin/acc`, seconda richiesta dello stesso giro): **tutt'e tre** i
riquadri — «ACC», «ACC sectors» e «Regulated areas» — si chiudono dal loro titolo. ⚠️ Il riquadro degli ACC un titolo di sezione **non ce l'ha** — era
...
scegliendo un ACC il riquadro dei settori si riapre da sé con le sue 11 righe. Le **aree** su LIRR sono
**105** e chiuderle porta la pagina da **7 025 px a 2 537 px**.
