...
| [design/regole-ui-pagine-admin.md](design/regole-ui-pagine-admin.md) | **Regole di densità e uso delle pagine admin** (19 ago 2026): testata in una riga, prosa nei «?», altezza misurata (e le due unità dello zoom), tabelle lunghe, scritture che si accumulano, comandi che non saltano. Nate dai tre giri su accordi / struttura / ACC: da applicare alle pagine ancora da fare. |
