...
| [feature/2026-08-03-aree-regolamentate-hardening.md](feature/2026-08-03-aree-regolamentate-hardening.md) | **Aree regolamentate**: categoria di import `SpecialAreas` (escludere = congelare, non «manuale»), dettaglio shape saltato quando è già in archivio, rilievo «Area regolamentata dangling» in diagnostica + marcatura nell'editor. In coda: il default dei flag bool nuovi, che nasceva `false` anche sul reconciler Postgres. |
