...
⚠️ Il **vecchio** `/services/airspace` resta una **seconda rotta della stessa pagina**: è stato pubblico per
giorni, sta nei collegamenti già scritti e nella scheda di chi ha aperto il sito ieri. Una rotta in più
costa una riga; un 404 costa una segnalazione. Chi ci arriva trova la stessa pagina — quindi anche lo stesso
rifiuto.
...
`/services/vsop/airspace` **dentro la sezione dello staff** e marcata scorciatoia, il vecchio indirizzo non
compare più fra le schede, e **tutt'e due gli indirizzi** aprono la mappa (7 famiglie, 28 tessere Esri,
attribuzione a posto). ⚠️ Il **rifiuto** non è stato provato dal vivo — l'utente di sviluppo è staff — ma lo
