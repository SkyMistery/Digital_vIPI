...
`S3` Aeroporti alternati → `S4` coordinate soglia → `S5`/`S6`/`S7` nominativi, parcheggi, attività delle
aree → reti e lingua → verifica a schermo su **LIMN Cameri**.
