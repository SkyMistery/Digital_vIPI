...
### 📦 A19 — Pacchetto 1.3.0, 31 agosto 2026 notte: 22 file — 🔴 **DA CARICARE**
...
- 🔴 **Caricare**, con la copia di sicurezza del database fatta prima. Foglio:
  `deploy/atc-ivao/LEGGIMI-PACCHETTO-1.3.0.md`.
- 🔴 **Dopo il caricamento**, la stessa prova puntata fuori, mentre chi ha caricato è ancora al telefono:
