...
### 📦 A18 — Pacchetto 1.2.0, 31 agosto 2026: 20 file — 🔴 **DA CARICARE STASERA**
...
#### 🔴 Perché «stasera», e non «quando capita»
...
- 🔴 **Caricare**, e fare i tre controlli del foglio **stasera**.
- 🔴 Dopo il caricamento: **§AM2**, la verifica dal vivo delle corse — si vedono solo con la latenza di un
  database remoto, da un'identità con permessi di editor, subito dopo un riavvio.
- 🟡 **§AM3**: rileggere `avvii.txt` fra qualche giorno. La conferma che la perdita di memoria è chiusa è
  **l'assenza** di righe «NON si è spento in modo ordinato».
- 🟡 **§AM4**: cancellare `errori-richieste.txt` sul server.
