...
| 14 | [14-quattro-documenti.md](14-quattro-documenti.md) | I **quattro** documenti (l'aeroporto entra nel confronto): guardia release nel servizio, ciclo AIRAC via dalla vLOA, snapshot una volta per pagina, guscio unico degli editor, ciclo unico dei viewer, sezioni dal catalogo alla nascita, un enum solo — **+ prove di parità sui cinque profili** | ✅ eseguito (P1→P8), suite 5680, verifica live sull'app vera due volte |
