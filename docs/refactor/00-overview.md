...
>
> **Estensione post-audit:** doc 11 (uniformità dei tre documenti: vIPI ACC / vIPI APP / vLOA) — **eseguito ✅** (P1→P6, 2026-07-30), branch `fix/uniformita-tre-documenti`, suite 657 verde, verifica live 20/20.
...
| 11 | [11-uniformita-tre-documenti.md](11-uniformita-tre-documenti.md) | Uniformità vIPI ACC / vIPI APP / vLOA fra editor, bozza e pubblica (estende 08-10) | ✅ eseguito (P1→P6), suite 657, verify live 20/20 |
