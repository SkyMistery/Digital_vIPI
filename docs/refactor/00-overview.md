...
| 15 | [15-shape-del-settore-una-porta-sola.md](15-shape-del-settore-una-porta-sola.md) | La **shape di un settore** — anello **e** quote insieme — da colonna a **elenco di pezzi con una fonte**, letta da **una porta sola**: l'aggancio all'AIP vale per tutti i motori, non per due su sei | 🟡 S0→S10 **fatte, verificate dal vivo e fuse in `main`**; resta **S11** (§4-bis: non è una slice) |
