...
- **Gerarchia delle posizioni d'aeroporto (2026-07-31).** Il padre si imposta sul nodo **Aeroporto** in
  ...
  `/vsop/admin/sectorstructure`. Regola pura in `Vipi.Domain.Services.AirportPositionLadder`, condivisa fra
...
### 9.25 `CoordinationAgreement` — l'accordo prende il posto del flusso (sessione 16 ago 2026) 🟡
...
> **Supera §9.20 / -bis / -ter**, che restano come storia dell'area finché il travaso non è fatto: al termine
> `TransferFlow` e `TransferPoint` non esistono più.
