...
{
    /// <summary>
    /// **Passo 3 di 3: si toglie il vecchio.** Gemella MySQL/MariaDB di
    /// <c>20260818115838_AgreementSectionsFinalize</c>: le colonne nuove diventano <c>NOT NULL</c>, nasce
    /// l'indice unico sulla coppia, e spariscono <c>AgreementParties</c>, <c>TrafficKind</c>,
    /// <c>Description</c>, <c>Direction</c> e le due <c>AgreementId</c>.
    ///
    /// <para>⚠️ <b>Va applicata solo DOPO la conversione</b> (<c>tools/Vipi.AgreementsToSections</c>). Su un
    /// archivio non convertito fallisce, ed è voluto: il <c>NOT NULL</c> non passa su colonne ancora nulle, e
    /// l'indice unico non passa se due accordi descrivono ancora la stessa coppia. Un fallimento rumoroso è
    /// l'unica protezione che vale — la trappola pagata a ferragosto è quella di una passata che «non trova
    /// niente, scrive zero, e i dati spariscono senza un errore».</para>
    ///
    ...
    public partial class AgreementSectionsFinalize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // ⚠️ Il NOT NULL è la guardia: su un archivio non convertito queste colonne sono ancora nulle e la
