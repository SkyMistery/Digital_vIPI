...
public static class GuideSearchCatalog
{
    ...
    public static readonly IReadOnlyList<Entry> Entries = new[]
    {
        ...
        new Entry("aree", "Leggere le aree regolamentate", "aree area regolamentata regolamentate special area zona zone militari R D P TSA TRA restricted danger prohibited chip pastiglia mappa 2d 3d filtro tipo colore quota banda descrizione", "La mappa unica delle aree regolamentate: le pastiglie, i filtri per tipo, i colori e le descrizioni."),
        ...
        new Entry("editor-validita", "Validità e revisione", "validita validità revisione ciclo airac appartenenza data in vigore dal effective from revisione reviewed by chi ha pubblicato firmatario nome vid posizione staff timbro non ancora pubblicato non registrato review cycle signatory", "I tre campi che il documento scrive da sé quando lo pubblichi: ciclo AIRAC, data e chi ha premuto Pubblica."),
        ...
        new Entry("editor-mil", "Editor vSOP militare", "militare militari mil vsop sop aeronautica base campo qra scramble boat bassa quota aree di lavoro destinatario pilota atc chip italiano traduzione inglese aviano ghedi rivolto decimomannu istrana grosseto amendola gioia del colle", "L'editor del vSOP militare d'aeroporto: italiano, destinatario per sezione, aree di lavoro, release."),
