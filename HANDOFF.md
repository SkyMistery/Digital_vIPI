...
**Ultimo aggiornamento:** 17 settembre 2026 (notte) — ✅ **1.32.0 È ONLINE** (§A68: timbro e `Schema 0` confermati, colonna «Mai usare» presente in vIPI e vSOP). 🟡 **§A69 in main, NON in pacchetto**: le caselle DEP/ARR diventano chip `sh-chip` come le colonne accanto, **rosse** quando accese (`sh-chip.no`); solo `Vipi.Ui` + `vipi-theme.css`, nessuna migrazione. Test bUnit provati per mutazione, verifica dal vivo in scuro/chiaro e sull'editor militare, contrasto 5,56:1. ▶ Pacchetto PATCH 1.32.1 solo se chiesto. 🔴 net10 = **1.33.0**.
