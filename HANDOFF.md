...
- ⚠️ **Da decidere col committente prima della slice 8**: i **tracciati a più tratti** (le zone dei `.str` coi segmenti, il `Track` delle `.sid`) tengono i punti dentro i loro segmenti e la slice 7 non li tocca. Serve una slice a parte?
