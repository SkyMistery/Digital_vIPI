...
**Ultimo aggiornamento:** 22 settembre 2026 (notte) — 📦 **1.42.1 PRONTO DA CARICARE** (§A114): PATCH, **nessuna migrazione**, **4 file in radice** (`Vipi.Application` + `Vipi.Host`, dll e pdb), timbro `1.42.1 · a66f25e`, zip `f76baed2…82059`, foglio `deploy/atc-ivao/LEGGIMI-PACCHETTO-1.42.1.md`. I **chief d'ACC** (`LIxx-CH`) entrano nel roster degli staffisti: erano Redattori ma invisibili in Diagnostica e nel selettore dei permessi, perché il roster accettava solo i codici `IT-`. `…-CHA1` resta senza permessi da staff: si promuove a mano (decisione del committente). In mezzo, già online: 1.40.0 (net10), 1.41.0/1.41.1 (documenti collegati), 1.42.0 (Sector Lab F1) — dettaglio in `docs/lavori-aperti.md` §A107–§A113.
