...
**Ultimo aggiornamento:** 21 settembre 2026 (notte, fine) — ✅ **1.39.0 È ONLINE** (§A102): il committente conferma timbro, `Schema 0`, colori MIL verdi / FSS petrolio, STAR nascoste. Da fuori `pacchetto-verifica.js` 8/8 e `mappa-foglio-verifica.js` 8/8 sulla vIPI pubblica di LIBB (mappe intere anche arrivando da un'altra pagina). 🔎 **Alla ripresa**: la vIPI pubblica di LIBB dice «No SCCAM/FIC sector in this ACC» — nell'editor di produzione guardare se i settori MIL/FSS di LIBB ci sono (se sì, ripubblicare; se no, anagrafica settori). ▶ Resta da ripubblicare vIPI ACC e scali. In `main` non resta codice fuori pacchetto. 🔴 **net10 = 1.40.0.**
