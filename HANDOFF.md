...
**Ultimo aggiornamento:** 21 settembre 2026 (notte, ultima) — ✅ **1.39.1 È ONLINE** (§A105): il committente conferma timbro 1.39.1, `Schema 0` e sommari funzionanti. Da fuori `pacchetto-verifica.js` verde e `gruppi-toc-verifica.js` verde sulla vIPI pubblica di LIBB (un clic su «Settori di aerovia» chiude tutto il gruppo). Porta §A103: nel sommario un gruppo intestato (documento di una pagina unita, blocco della vIPI ACC) si chiude e si apre tutto intero. In `main` non resta codice fuori pacchetto. 🔎 Resta aperto da 1.39.0: SCCAM/FIC «No sector» nella vIPI pubblica di LIBB (vedi sotto). ▶ Ripubblicare vIPI ACC e scali. 🔴 **net10 = 1.40.0, DA SOLA** (scelta del committente: un guasto, una causa).
