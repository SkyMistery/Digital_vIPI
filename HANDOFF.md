...
▶ **In main e NON in pacchetto** dopo 1.26.0: i lotti **L2, L5, L6, L7, L8, L9, L10, L11** della revisione totale 2, nessuna migrazione → **1.26.1** quando il committente lo chiede. ▶ **Prossimo lavoro: L12** (garanzie, test, documenti), poi **L13** (piattaforma). ▶ Restano col login: `Schema: 0`, chiave al validatore dei tour e `Api__RichiediChiave=true`.
