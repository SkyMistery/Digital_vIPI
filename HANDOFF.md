...
**Ultimo aggiornamento:** 17 settembre 2026 (mezzogiorno) — 📦 **1.30.3 PRONTO DA CARICARE** (§A60): PATCH, 2 file (`Vipi.Host.dll`+`.pdb`), timbro `1.30.3 · b5be0ff`, zip `de4a8db6…bcee`, nessuna migrazione. Porta §A59, il registro del giorno in `diagnostica/` (`richieste-*.tsv`, `log-*.txt`, sette giorni). Provato sul pacchetto su copia prod in MariaDB: 10/10, file nati giusti. ▶ Dopo il carico: timbro, Ricerca, `Schema 0`, i due file del giorno via FTP. 🔴 net10 = **1.31.0**.
