...
**Ultimo aggiornamento:** 3 settembre 2026 — ✅ **1.5.0 È IN PRODUZIONE**, verificata dall'esterno: otto controlli pubblici verdi, tre documenti veri aperti col riquadro «Validità e revisione» a posto, e la **guida in-app** che porta il testo esistente solo in 1.5.0 — prova pubblica che girano i binari nuovi. Timbro `1.5.0 · a071575`, 13 file, sha256 `17e0072f…`, nessuna migrazione. 🔴 **Due code**: la riga **inglese** delle SID nella guida diceva ancora la regola vecchia (corretta in `main`, **non** ancora online — va con la prossima consegna), e resta da guardare `diagnostica/` per il timbro e l'assenza di `errori-richieste.txt`. Prima: ✅ 1.4.1 e ✅ 1.4.0. Vedi il riquadro sotto «Dove siamo».
