...
**Ultimo aggiornamento:** 2 settembre 2026, notte — 📦 **PACCHETTO 1.5.0 PRONTO, DA CARICARE.** Timbro `1.5.0 · a071575`, **13 file**, sha256 `17e0072f…`, **nessuna migrazione**. Dentro: la **corsa del blocco allegato** letta nella diagnostica di 1.4.1 (più i suoi due fratelli e il registro eventi di Windows) e **§AW, il ciclo entrante** (sezione «Prossimo AIRAC», la deriva che guarda avanti, il ciclo delle SID dichiarato dalla sorgente, lo sweep giornaliero). ⚠️ È **1.5.0 e non 1.4.2** perché il contenuto complessivo ha una sezione nuova. 🟢 Tutto in `main` (`a071575`), nessun ramo aperto. Prima: ✅ **1.4.1 È IN PRODUZIONE** (timbro `1.4.1 · 42f23f9`), e prima ancora ✅ **1.4.0**. Vedi il riquadro sotto «Dove siamo».
